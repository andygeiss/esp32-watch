 ...
 * Montserrat-Medium.ttf 72 px, 0x2F-0x39, digits rewritten to a fixed 48 px advance so
 * that nothing shifts when a digit changes.
 */
/*******************************************************************************
 * Size: 72 px
 * Bpp: 4
 * Opts: --font /Users/andygeiss/workspace/waveshare-watch/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --range 0x2F-0x39 --size 72 --bpp 4 --no-compress --no-prefilter --no-kerning --format lvgl --lv-font-name ui_font_date_72 -o /Users/andygeiss/workspace/waveshare-watch/ui_font_date_72.c
 ******************************************************************************/
...
#ifndef UI_FONT_DATE_72
#define UI_FONT_DATE_72 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 406, .box_w = 32, .box_h = 69, .ofs_x = -3, .ofs_y = -7},
    {.bitmap_index = 1104, .adv_w = 768, .box_w = 42, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2217, .adv_w = 768, .box_w = 20, .box_h = 51, .ofs_x = 14, .ofs_y = 0},
    {.bitmap_index = 2727, .adv_w = 768, .box_w = 38, .box_h = 52, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 3715, .adv_w = 768, .box_w = 38, .box_h = 52, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 4703, .adv_w = 768, .box_w = 46, .box_h = 51, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5876, .adv_w = 768, .box_w = 38, .box_h = 52, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 6864, .adv_w = 768, .box_w = 40, .box_h = 53, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 7924, .adv_w = 768, .box_w = 39, .box_h = 51, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 8919, .adv_w = 768, .box_w = 41, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 10006, .adv_w = 768, .box_w = 39, .box_h = 53, .ofs_x = 4, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_date_72 = {
#else
lv_font_t ui_font_date_72 = {
#endif
